...
public class MVM_shop_tool_QA {
	WebDriver driver;
	public String baseUrl = "http://shopadmin-qa.playstudios.com/shopadmin/#/mvmshop/management/shopevents";
	...
	public void importJSON() throws Exception {
		...
		driver.findElement(By.xpath("//input[@id='rootfileInput']"))
				.sendKeys("C:/Users/ryan.wahid/Videos/autoMVM.json");
	...
	public void tests_field_values() throws Exception {
		...
		/*
		 * try { String randoPID = RandomStringUtils.randomNumeric(3); This generates
		 * random String WebElement pid =
		 * driver.findElement(By.xpath("//input[@id='PlayerIds']")); pid.sendKeys("2" +
		 * randoPID); pid.getText(); System.out.println("PlayerID: is set");
		 * 
		 * } catch (Exception e) {
		 * 
	...
	@Test(priority = 6)
	public void checking_Platform() throws Exception {
		...
		try {
			...
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(By.xpath(
					"//mat-option[@id='mat-option-2']//mat-pseudo-checkbox[@class='mat-option-pseudo-checkbox mat-pseudo-checkbox ng-star-inserted mat-pseudo-checkbox-checked']")));
		...
		try {
			...
			Platform.click();
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(By.xpath(
					"//mat-pseudo-checkbox[@class='mat-option-pseudo-checkbox mat-pseudo-checkbox ng-star-inserted']")));
	...
	public void newEventThemecreate() throws Exception {
		...
		try {
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(
					By.xpath("(//span[@class='mat-button-wrapper']//*[text()[contains(.,'add_circle')]])[1]")));
		} catch (Exception e) {
		...
		Thread.sleep(1500);
		try {
			driver.findElement(By.xpath("(//div[@formarrayname='ShopEventThemes']//mat-icon[text()='delete'])[3]"))
					.click();
		} catch (Exception e) {
	...
	public void Shops_edit() throws Exception {
		...
		// Edits existing Shop
		try {
			driver.findElement(By.xpath("(//div[@formarrayname='FormShopLogics']//mat-icon[text()='edit'])[1]"))
					.click();
		} catch (Exception e) {
		...
		// Edits Shop Priority
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement Editp = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("(//div[@class='mat-form-field-wrapper']//input[@id='Priority'])[2]")));
		Editp.clear();
		Thread.sleep(1000);
		Editp.sendKeys("10");
	...
	@Test(priority = 11)
	public void editing_Shop_Platform() throws Exception {

		// clicks Platform dropdown
		((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(
				By.xpath("(//div[@class='mat-select-arrow-wrapper']//div[@class='mat-select-arrow'])[2]")));
		...
		try {
			...
			WebDriverWait wait = new WebDriverWait(driver, 10);
			// Selecting Apple
			WebElement paltApple = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
					"(//div[@class='mat-select-content ng-trigger ng-trigger-fadeInContent']//mat-pseudo-checkbox[@class='mat-option-pseudo-checkbox mat-pseudo-checkbox ng-star-inserted'])[1]")));
			paltApple.click();
			Thread.sleep(500);
			// Closing popup
		...
		try {
			driver.findElement(By.xpath("(//button[@class='mat-raised-button']//span[contains(text(),'Save')])[2]"))
					.click();
		} catch (Exception e) {
			System.out.println("Failed to select Platform: Apple");
			throw (e);
	...
	@Test(priority = 12)
	public void Saving_Edited_Event() throws Exception {
		WebDriverWait wait = new WebDriverWait(driver, 10);
		WebElement saveEvent = wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//button[@class='mat-raised-button']//span[contains(text(),'Save Shop Event')]")));
		saveEvent.click();
		Thread.sleep(2000);
	}
